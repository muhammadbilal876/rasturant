      ...
      <div className="footer-content">
        <div className="footer-content-column">
          <div className="footer-logo">
            <a className="footer-logo-link" href="#logo">
              {/* <span className="hidden-link-text text-white"></span> */}
              {/* Food<span style={{color:'orange'}}>Planet</span> */}
              <h1 className="text-white">Food<span style={{color:'orange'}}>Planet</span></h1>
            </a>
          </div>
          <div className="footer-menu">
            ...
            <ul id="menu-get-started" className="footer-menu-list">
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
                <a href="description">The customer is at the heart of our unique business model, which includes design.</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-product">
        ...
        <div className="footer-content-column">
          <div className="footer-menu">
            ...
            <ul id="menu-quick-links" className="footer-menu-list">
              ...
              <li className="menu-item menu-item-type-custom menu-item-object-custom">
                <a target="_blank" rel="noopener noreferrer" href="#products">Products</a>
              </li>
              <li className="menu-item menu-item-type-post_type menu-item-object-page">
                <a href="#about">About</a>
              </li>
        ...
        <div className="footer-content-column">
          <div className="footer-call-to-action">
            ...
            <a className="footer-call-to-action-button button" href="#CTA" target="_self"> Get in Touch </a>
          </div>
          <div className="footer-call-to-action">
        ...
        <div className="footer-social-links"> <svg className="footer-social-amoeba-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 236 54">
          ...
          <a className="footer-social-link twitter" href="#twiter" target="_blank">
      ...
      <div className="footer-copyright">
        <div className="footer-copyright-wrapper">
          <p className="footer-copyright-text">
            <a href="CopyRight" className="footer-copyright-link" target="_self"> &copy; {year} . | Designed By: Muhammad Bilal. | All rights reserved. </a>
          </p>
        </div>
      </div>
    </footer>
